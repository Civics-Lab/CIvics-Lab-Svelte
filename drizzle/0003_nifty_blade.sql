...
CREATE TABLE IF NOT EXISTS "workspaces" (
	...
	"name" text NOT NULL,
	"logo" text,
	"has_engage" boolean DEFAULT true NOT NULL,
	"has_helpdesk" boolean DEFAULT false NOT NULL,
	"has_pathway" boolean DEFAULT false NOT NULL,
	"has_pulse" boolean DEFAULT false NOT NULL,
...
--> statement-breakpoint
DROP INDEX IF EXISTS "donation_tags_donation_id_idx";--> statement-breakpoint
ALTER TABLE "donation_tags" ALTER COLUMN "donation_id" DROP DEFAULT;--> statement-breakpoint
DO $$ BEGIN
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "user_invites" ADD CONSTRAINT "user_invites_workspace_id_workspaces_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
