  ...
  <div class="flex space-x-2">
    ...
    <div class="relative">
      <button
        ...
        class:bg-purple-50={filters.length > 0}
        class:text-purple-700={filters.length > 0}
        class:border-purple-300={filters.length > 0}
    ...
    <div class="relative">
      <button
        type="button"
        class="inline-flex items-center px-3 py-2 border border-gray-300 shadow-sm text-sm leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500"
        class:bg-purple-50={sorting.length > 0}
        class:text-purple-700={sorting.length > 0}
        class:border-purple-300={sorting.length > 0}
