    ...
    <aside class="w-64 bg-teal-950 shadow-md flex flex-col h-full border-r border-slate-200">
      ...
      <div class="p-4 flex items-center space-x-3">
        ...
        <div>
          ...
          <div class="text-teal-400 text-sm truncate max-w-[180px]">
      ...
      <nav class="flex-grow p-4 space-y-1 overflow-y-auto text-teal-500">
        <div class="mb-6">
          ...
          <a 
            href="/app" 
            class="flex items-center px-3 py-2 text-sm rounded-md mb-1 {isActive('/app') && !isActive('/app/') ? 'text-white font-medium hover:bg-teal-900' : 'text-teal-500 hover:bg-teal-900'}"
          >
          ...
          <a 
            href="/app/contacts" 
            class="flex items-center px-3 py-2 text-sm rounded-md mb-1 {isActive('/app/contacts') ? 'text-white font-medium hover:bg-teal-900' : 'text-teal-500 hover:bg-teal-900'}"
          >
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <a 
            href="/app/businesses" 
            class="flex items-center px-3 py-2 text-sm rounded-md mb-1 {isActive('/app/businesses') ? 'text-white font-medium hover:bg-teal-900' : 'text-teal-500 hover:bg-teal-900'}"
          >
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <a 
            href="/app/donations" 
            class="flex items-center px-3 py-2 text-sm rounded-md mb-1 {isActive('/app/donations') ? 'text-white font-medium hover:bg-teal-900' : 'text-teal-500 hover:bg-teal-900'}"
          >
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <!-- Sidebar Footer -->
      <div class="p-4 border-t border-teal-900">
        <p class="text-xs font-semibold text-teal-800 uppercase tracking-wider mb-3 px-3">
          Account
        </p>
        <ul class="space-y-1">
          <li>
            <a 
              href="/app/settings" 
              class="flex items-center px-3 py-2 text-sm rounded-md mb-1 text-teal-500 hover:bg-teal-900"
            >
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <li>
            <button 
              ...
              class="flex items-center w-full text-left px-3 py-2 text-sm rounded-md mb-1 text-red-400 hover:bg-red-500 hover:text-white"
            >
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
